...
class TemporalEmbeddingHandler:
    ...
    def extract_date_from_filename(self, filename: str) -> Optional[str]:
        ...
        # Try month name + day + year format (e.g., "January 07, 2025", "December 25, 2023")
        if not matches['full_date']:
            month_day_year_pattern = r'(January|February|March|April|May|June|July|August|September|October|November|December)[_\-\s]+(\d{1,2})[,\s]+(\d{4})'
